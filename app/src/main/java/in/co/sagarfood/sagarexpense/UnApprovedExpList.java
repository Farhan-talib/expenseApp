...
public class UnApprovedExpList extends AppCompatActivity {
...
//        });
    ...
    class UnverifiedExpenseAdapter extends RecyclerView.Adapter<UnverifiedExpenseAdapter.VH> {
...
//        }
        ...
        @Override
        public UnverifiedExpenseAdapter.VH onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.helper_expense_items, parent, false);
            return new UnverifiedExpenseAdapter.VH(v);
        }
