...
public class APIHelper {
    public static String BASE_URL = "https://attendance.sagarfood.co.in/";
    ...
    public static String GET_GODOWNS = "https://attendance.sagarfood.co.in/api/expenseApp.aspx/GetGodowns";
    public static String GET_EXPENSE_REPORT = "https://attendance.sagarfood.co.in/api/expenseApp.aspx/GetExpensesReport";
    public static String NEW_INCOME_ENTRY = "https://attendance.sagarfood.co.in/api/expenseApp.aspx/AddNewIncome";
